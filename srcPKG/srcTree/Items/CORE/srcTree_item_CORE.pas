...
type
 ...
 tSrcTree_item=class
  ...
  protected
    function  _chldFrst_:tSrcTree_item;
    function  _chldLast_:tSrcTree_item;
  protected
  ...
  public
    property ItemTEXT:string        read _item_Text_;
  ...
  public
    property ItemNAME:string read _get_ItemName_; // отображаемое наименование удля узла в дереве
    property ItemHINT:string read _get_ItemHint_;
  public
...
function tSrcTree_item._chldFrst_:tSrcTree_item;
begin
    result:=_chld_;
end;

function tSrcTree_item._chldLast_:tSrcTree_item;
begin
    result:=_chld_;
