...
uses
    ...
    in0k_CopyRAST__frmSTAGE_05_PostProcessing, 
    in0k_CopyRAST__frmSTAGE_LMR_CORE, in0k_lazarusIdeSRC_MacrosLIST, 
    in0k_lazarusIdeSRC_ideMacrosCODE, in0k_CopyRAST__stage_01__frm_cmpResult, 
    in0k_CopyRAST__STAGE_03__cmpLTREE, in0k_CopyRAST__cmpSTAGE_Tree, 
    in0k_CopyRAST__STAGE_04__copyFiles, in0k_CopyRAST__wndCORE_00, 
    in0k_CopyRAST__STAGE_03__cmpRTREE, in0k_CopyRAST__STAGE_04_configs, 
    lazExt_CopyRAST_fileSystemFNKs, in0k_CopyRAST__STAGE_05__editFiles, 
