unit uTST_003_srcTree_itemROOT__get_relPATH_a_W_c__xn;
...
type
 ...
 tUTST_srcTree_itemROOT__get_relPATH_a_W_c__xn= class(TTestCase)
  protected
    ROOT:tSrcTree_ROOT;
  ...
  published
    procedure relPATH_get_aWc_an;
    procedure relPATH_get_aWc_Wn;
    procedure relPATH_get_aWc_cn;
  end;
...
const
  c_FLDR_A='a';
  c_FLDR_B='Y'+DirectorySeparator+'b';
  c_FLDR_C='c';

procedure tUTST_srcTree_itemROOT__get_relPATH_a_W_c__xn.SetUp;
begin
...
procedure tUTST_srcTree_itemROOT__get_relPATH_a_W_c__xn.TearDown;
begin
    ROOT.FREE;
end;
...
procedure tUTST_srcTree_itemROOT__get_relPATH_a_W_c__xn.relPATH_get_aWc_an;
...
procedure tUTST_srcTree_itemROOT__get_relPATH_a_W_c__xn.relPATH_get_aWc_Wn;
var tst__Flder:string;
    resul__Get:_tSrcTree_item_fsNodeFLDR_;
begin
    // собсно ТЕСТ должен СОЗДАТЬ новую
...
procedure tUTST_srcTree_itemROOT__get_relPATH_a_W_c__xn.relPATH_get_aWc_cn;
var tst__Flder:string;
    resul__Get:_tSrcTree_item_fsNodeFLDR_;
begin
    // собсно ТЕСТ должен СОЗДАТЬ новую
...
initialization
    RegisterTest(tUTST_srcTree_itemROOT__get_relPATH_a_W_c__xn);
end.
